...
def test_ingest_pdf_parses_chunks_and_stores_documents() -> None:
    ...
    rag_service._pdf_loader.load.return_value = [source_document]
    rag_service._chunk_service.split_documents.return_value = [chunk]
    ...
    call_arguments = rag_service._vector_db_service.add_documents.call_args.kwargs
